...
type Value struct {
	...
	//	*Value_DoubleValue
	//	*Value_BoolValue
	Method        isValue_Method `protobuf_oneof:"method"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Value) GetMethod() isValue_Method {
	if x != nil {
		return x.Method
	}
	return nil
...
func (x *Value) GetStringValue() string {
	if x != nil {
		if x, ok := x.Method.(*Value_StringValue); ok {
...
func (x *Value) GetInt64Value() int64 {
	if x != nil {
		if x, ok := x.Method.(*Value_Int64Value); ok {
			return x.Int64Value
		}
	}
	return 0
...
func (x *Value) GetDoubleValue() float64 {
	if x != nil {
		if x, ok := x.Method.(*Value_DoubleValue); ok {
...
func (x *Value) GetBoolValue() bool {
	if x != nil {
		if x, ok := x.Method.(*Value_BoolValue); ok {
			return x.BoolValue
		}
	}
	return false
...
func (*Value_StringValue) isValue_Method() {}

func (*Value_Int64Value) isValue_Method() {}

func (*Value_DoubleValue) isValue_Method() {}

func (*Value_BoolValue) isValue_Method() {}
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\awebsite\x18\x03 \x01(\tR\awebsite\"\x9f\x01\n" +
	"\x05Value\x12#\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBIZGgithub.com/sunzhqr/spacecraft/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
